  ...
  return (
    <div className="flex flex-col h-full w-full max-w-5xl mx-auto overflow-hidden">
      ...
      >
        <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <span className="px-2 py-0.5 rounded-full text-[10px] font-black uppercase bg-emerald-500/15 text-emerald-500 border border-emerald-500/25 shrink-0">
                ₹{settings.reward_value}/Sale
              </span>
            </div>
            <p className="text-[10px] sm:text-xs text-slate-400 truncate hidden xs:block">
              Earn real cash commission by sharing TG Drive
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
          ...
          >
            <button
              type="button"
              className="px-2.5 sm:px-3 py-1.5 rounded-lg bg-emerald-500 text-slate-950 font-black shadow-xs flex items-center gap-1.5 cursor-pointer"
            >
      ...
      <div className="flex-1 overflow-y-auto px-3.5 sm:px-6 py-4 space-y-4 sm:space-y-5 pb-[calc(6rem+env(safe-area-inset-bottom,24px))]">
        ...
        <div
          className={`relative overflow-hidden rounded-3xl border p-4 sm:p-6 shadow-lg transition-all ${
            isLight
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 sm:gap-6">
            ...
            <div
              className={`w-full md:w-auto p-3.5 sm:p-4 rounded-2xl border space-y-2.5 text-center md:text-left shrink-0 backdrop-blur-md ${
                isLight ? 'bg-white/90 border-slate-200 shadow-sm' : 'bg-slate-900/80 border-slate-700/80'
              }`}
            >
        ...
        <div
          className={`p-4 sm:p-5 rounded-3xl border space-y-3.5 sm:space-y-4 shadow-sm ${
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 sm:gap-3">
            ...
            >
              ...
              <button
                ...
                className="px-3.5 sm:px-4 py-2 rounded-xl bg-emerald-500 hover:bg-emerald-400 active:scale-95 text-slate-950 text-xs font-black transition-all flex items-center gap-1.5 shadow-sm cursor-pointer shrink-0"
              >
