...
import { ShieldCheck, Sun, Moon, ExternalLink, X } from "lucide-react";
...
export function AuthWizard({ onLogin }: { onLogin: () => void }) {
    ...
    const handleOpenTelegramOrg = async () => {
        await openExternalUrl('https://my.telegram.org');
    };
        ...
        <div className="auth-gradient relative flex h-full w-full items-center justify-center overflow-y-auto p-4 pt-[calc(1rem+env(safe-area-inset-top,24px))] text-app-text sm:p-6">
            ...
            >
                <div className="mb-6 text-center">
                    <div className="mx-auto mb-3 flex h-14 w-14 items-center justify-center bg-transparent">
                        <img src="/inapp_logo.png" alt="Logo" className="w-full h-full object-contain bg-transparent drop-shadow-sm" />
                    </div>
                    <h1 className="brand-header-title text-2xl">
                            ...
                            <div className="space-y-5 text-app-text">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="ms-7 text-ui leading-relaxed text-app-text-secondary">
                                        Visit <button type="button" onClick={(e) => { e.preventDefault(); void handleOpenTelegramOrg(); }} className="cursor-pointer text-app-accent underline hover:text-app-text">my.telegram.org</button> and log in with your phone number.
                                    </p>
                                </div>
                                ...
                                <button
                                    type="button"
                                    onClick={(e) => { e.preventDefault(); void handleOpenTelegramOrg(); }}
