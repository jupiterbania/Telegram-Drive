    ...
    <motion.section key="about" {...tabMotion} className="w-full space-y-4">
      <div className="flex flex-col items-center space-y-5 py-6">
        ...
        <div className="space-y-3 text-center">
          ...
          <button onClick={event => { event.preventDefault(); void openExternalUrl('https://www.cameronamer.com'); }} className="flex cursor-pointer items-center justify-center gap-1.5 text-xs text-telegram-primary transition-colors hover:text-telegram-primary/80"><Globe className="h-3.5 w-3.5" />www.cameronamer.com</button>
          <button onClick={event => { event.preventDefault(); void openExternalUrl('https://github.com/caamer20/telegram-drive'); }} className="flex cursor-pointer items-center justify-center gap-1.5 text-xs text-telegram-primary transition-colors hover:text-telegram-primary/80">
